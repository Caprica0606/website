...
<body >
  ...
  <div col-9 align = "center">
    <p >do-While loops will execute a block of code as long as a condition is met.
      The condition will be checked at the end of each iteration.  What is <thead>
      difference between a do-while loop and a while loop></p>
      <p>do-while loops check for the condition at he end of each iteration
      and while loops check for the condition at the begining of the iteration.</p>
  <br></br>
     <h2>do-while Loop Syntax</h2>
     <img align = "center" src = "doWhileLoopSyn.PNG">
     <br></br>
     <h2>do-while loop examples</h2>
