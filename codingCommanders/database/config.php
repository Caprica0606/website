...
$config['images_locations'] = Array( 1 => 'Left side', 2 => 'Right side', 0 => 'No display' ); // default value: Array( 1 => 'Left side', 2 => 'Right side', 0 => 'No display' )
...
* More: http://opensolution.org/docs/?p=en-settings#short_to_full_description
*/
...
// Default slider setting, find more possible options in the manual: http://opensolution.org/docs/?p=en-design#libraries
